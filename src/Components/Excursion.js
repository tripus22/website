    ...
    return (
        <Container theme={props.theme.theme}>
            ...
            <Column style={{margin: '20px 0 0 0'}}>
                ...
                <Row>
                    <p> Price of Activity: <Moment format='LL'>{groupInfo.Founding_Date}</Moment></p>
                ...
                <Row>
                    <SelectGroup onClick={() => handleRoute('/excursionDetails', groupInfo)}>Book Activity</SelectGroup>
                </Row>
            </Column>
        </Container>
    );
