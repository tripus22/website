...
function FlightDetails(props) {
    ...
    let myButton;
    if (true) {
        myButton = <Button onClick={() => handleRoute('/flightFilter')}> Add Flight</Button>;
    } else {
        myButton = <Button onClick={() => handleRoute('/editFlight')}> Edit Flight</Button>;
    }
