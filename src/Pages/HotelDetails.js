...
function ExcursionDetails(props) {
    ...
    let myButton;
    if (true) {
        myButton = <Button onClick={() => handleRoute('/hotelFilter')}> Add Hotel</Button>;
    } else {
        myButton = <Button onClick={() => handleRoute('/editHotel')}> Edit Hotel</Button>;
    }
